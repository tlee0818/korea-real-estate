...
_PRICE_TRENDS = "SttsApiTblData.do"
...
class RebClient(BaseHttpClient):
    ...
    Auth: KEY query param, encapsulated here.
    """
    ...
    def get_price_trends(
        ...
        """
        지가변동률 / 주택가격동향 — price trend index for a region and period.
        ...
        return self._call(_PRICE_TRENDS, _p(
